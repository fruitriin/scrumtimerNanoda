...
> **注記 (2026-05-16)**: オーナーフィードバックにより、本計画のアクセシビリティ部分は訂正予定。
> ネイティブブラウザでの体験を一級とする方針に沿って、`Plan 0018-accessibility-policy-realignment.md`
> で再評価する。レスポンシブ改善（タッチターゲット拡大・モバイル padding 調整等）は対象外。
