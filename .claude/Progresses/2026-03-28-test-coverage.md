...
## タスク: Plan 0008 — テストカバレッジ改善

### 優先度高
- [x] useAudio テスト新規作成 (`src/composables/useAudio.test.ts`)
- [x] useTimer.applyTimerState テスト追加

### 優先度中
- [x] useParticipants マスター分離テスト追加
- [x] useSettings.alerts テスト追加

### 品質ゲート
- [x] Stage 1: `vp build && vp check src/ && vp test run` — 50テスト全パス
- [x] Stage 2: コードレビュー（W-1修正済み）・コントリビューション分析（候補なし）
- [x] 完了処理
