...
## タスク: Plan 0013 — バンドルサイズ最適化

- [x] MemoEditor を defineAsyncComponent で遅延ロード
- [x] PublicMemoList を defineAsyncComponent で遅延ロード
- [x] Stage 1 全パス
- [x] Stage 2（Warning修正: ローディング/エラーフォールバック追加）
- [x] 完了処理
