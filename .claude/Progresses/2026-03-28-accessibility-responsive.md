...
## タスク: Plan 0012 — アクセシビリティ & レスポンシブ改善

### アクセシビリティ
- [ ] TimerView: プログレスバーに role="progressbar" + aria 属性
- [ ] TimerView: アイコンボタンに aria-label
- [ ] AudioPanel: ボタンに aria-label
- [ ] RoomPanel: ステータスに role="status"
- [ ] NavBar: role="navigation" + aria-label
- [ ] フォーム入力に aria-label

### レスポンシブ
- [ ] タッチターゲット最低 44x44px
- [ ] NavBar モバイル対応（横スクロール）
